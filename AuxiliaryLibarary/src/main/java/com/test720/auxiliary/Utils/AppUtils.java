...
import com.test720.auxiliary.BuildConfig;
...
public final class AppUtils {
     ...
     * <li>if {@link android.app.ActivityManager#getRunningAppProcesses()} is null,
     * return false</li>
     * <li>if one process of
     * {@link android.app.ActivityManager#getRunningAppProcesses()} is equal to
    ...
    public static String getUUID(Context context) {
        ...
        if (BuildConfig.DEBUG) android.util.Log.d(TAG, "uuid=" + uniqueId);
