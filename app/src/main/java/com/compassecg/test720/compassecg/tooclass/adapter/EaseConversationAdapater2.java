...
import com.compassecg.test720.compassecg.tooclass.utils.EaseSmileUtils;
 ...
 * 会话列表adapter
 */
public class EaseConversationAdapater2 extends ArrayAdapter<EMConversation> {
    ...
    public EaseConversationAdapater2(Context context, int resource, List<EMConversation> objects, List<String> list,List<String>list1) {
...
//            holder.name.setText(group != null ? group.getGroupName() : username);
            ...
            String jpg = Connector.lll + list1.get(position);
            Glide.with(mContext)
                    .load(jpg)
                    .centerCrop()
...
//			holder.name.setText(room != null && !TextUtils.isEmpty(room.getName()) ? room.getName() : username);
            EaseUserUtils.setUserNick(list.get(position), holder.name);
        } else {
//		EaseUserUtils.setUserAvatar(getContext(), username, holder.avatar);
            L.e("myusername", username);
            String jpg = Connector.lll + list1.get(position);
            Glide.with(mContext)
                    .load(jpg)
                    .placeholder(R.drawable.touxiang)
