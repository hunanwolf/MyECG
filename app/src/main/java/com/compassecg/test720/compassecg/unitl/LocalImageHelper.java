...
public class LocalImageHelper {
    public static LocalFile fake = new LocalFile();
    public LocalFile getFake(){
        return fake;
    }
    ...
    final List<LocalFile> checkedItemflase = new ArrayList<>();//身份证正反面
    ...
    public List<LocalFile> getCheckedItemflase() {
        return checkedItemflase;
    }
    ...
    public void clearflase(){
        checkedItemflase.clear();
        currentSize=(0);
        String foloder= getCachePath()
                + "/PostPicture/";
        File savedir = new File(foloder);
